...
| launch_configuration_worker_group_count | The number of maps contained within the worker_groups list. | string | `1` | no |
| launch_configuration_worker_groups | A list of maps defining worker group configurations to be defined using AWS Launch Configurations. See workers_group_defaults for valid keys. | list | `<list>` | no |
| launch_template_worker_group_count | The number of maps contained within the worker_groups list. | string | `0` | no |
| launch_template_worker_groups | A list of maps defining worker group configurations to be defined using AWS Launch Templates. See workers_group_defaults for valid keys. | list | `<list>` | no |
