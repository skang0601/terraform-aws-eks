...
data "template_file" "launch_configuration_worker_role_arns" {
...
data "template_file" "config_map_aws_auth" {
  ...
  vars {
    worker_role_arn = "${join("", distinct(concat(data.template_file.launch_template_worker_role_arns.*.rendered, data.template_file.launch_configuration_worker_role_arns.*.rendered)))}"
